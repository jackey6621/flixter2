...
class AlbumsViewController: UIViewController, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let imageUrl = URL(string: "https://image.tmdb.org/t/p/w500" + album.backdrop_path)!
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://api.themoviedb.org/3/movie/now_playing?api_key=947f7b0267fc506b404310c82d2d4681")!
